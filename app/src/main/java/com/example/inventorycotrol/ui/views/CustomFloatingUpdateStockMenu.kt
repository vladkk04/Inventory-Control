...
import com.example.inventorycotrol.databinding.CustomFloatingActionButtonUpdateStockMenuBinding
...
class CustomFloatingUpdateStockMenu (
    ...
    fun setOnUpdateStockClickListener(onClick : () -> Unit)
    {
        popupBinding.fabUdpateStock.setOnClickListener {
            onClick()
            dismissPopup()
        }
    }
