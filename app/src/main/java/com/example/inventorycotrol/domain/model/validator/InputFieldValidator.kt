...
class InputValidator private constructor(
    ...
    fun withMaxLength(maxLength: Int, errorMessage: String = "Invalid value") =
        customValidation({ it.length > maxLength }, errorMessage)

    fun withTheSameValueEqual(value: String, errorMessage: String = "Invalid value") =
        customValidation({ it == value }, errorMessage)
