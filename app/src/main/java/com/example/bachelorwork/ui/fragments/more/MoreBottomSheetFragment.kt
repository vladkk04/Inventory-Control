...
import com.example.bachelorwork.databinding.FragmentModalBottomSheetMoreBinding
...
class MoreBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private var _binding: FragmentModalBottomSheetMoreBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentModalBottomSheetMoreBinding.inflate(inflater, container, false)
        setupFabButtons()
        return binding.root
    }
    ...
    private fun setupFabButtons() {
        binding.fabManageEmployees.setOnClickListener {
