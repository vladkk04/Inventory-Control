package com.example.bachelorwork.ui.fragments.orders.create.addProduct
...
import com.example.bachelorwork.ui.fragments.orders.create.OrderAddProductSharedViewModel
import com.example.bachelorwork.ui.model.order.OrderAddProductUiState
import com.example.bachelorwork.ui.model.order.OrderSelectableProductUi
import com.example.bachelorwork.ui.model.order.create.OrderAddProductFormEvent
import com.example.bachelorwork.ui.model.order.create.OrderAddProductFormUiState
...
class OrderAddProductModalBottomSheetFragment :
    ...
    private val sharedViewModel: OrderAddProductSharedViewModel by viewModels(ownerProducer = { requireParentFragment() })
