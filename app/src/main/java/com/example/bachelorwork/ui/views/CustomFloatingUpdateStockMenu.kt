...
import com.example.bachelorwork.databinding.CustomFloatingActionButtonUpdateStockMenuBinding

class CustomFloatingUpdateStockMenu (
    private val context: Context,
    private val anchorView: View
) {
    private val popupBinding =
        CustomFloatingActionButtonUpdateStockMenuBinding.inflate(LayoutInflater.from(context))
    ...
    fun setOnStockInClickListener(onClick : () -> Unit)
    {
        popupBinding.fabStockIn.setOnClickListener {
            onClick()
            dismissPopup()
        }
    }

    fun setOnStockOutClickListener(onClick : () -> Unit)
    {
        popupBinding.fabStockOut.setOnClickListener {
            onClick()
            dismissPopup()
        }
    }
