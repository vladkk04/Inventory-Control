...
import com.example.bachelorwork.domain.model.product.Product.ProductUnit
...
class ProductCreateModalBottomSheetFragment :
    ...
    override fun setupViews() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            launch { observeFormFieldUIState() }
        }
    }
    ...
    private fun setupNumberPicker() {
        binding.numberPickerSelectUnit.apply {
            maxValue = Product.ProductUnit.entries.size - 1
    ...
    private suspend fun observeFormFieldUIState() = viewModel.uiFormState.collectLatest { uiState ->
